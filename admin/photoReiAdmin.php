...
<head>
    ...
    <link rel="stylesheet" href="../css/adminPhotoRei.css">
    ...
    <section>
        ...
        <img src="../img/index_html/logoCirVer.png" alt="">
            <ul class="center-nav">
                ...
                <li><i class="fa fa-cube" style="color: rgb(8, 0, 252);"></i><a href="#" onclick="document.location='./../admin/photoReiAdmin?key=e8b7d2f4e9b47c8eaf3d5d7b9e1a2c8f9b1d4e7a8c7b8f1a3d7b8e1a4b9c8d7e'" style="color: rgb(8, 0, 252);" > Фото-рэй </a></li>
        ...
        <div class="main-content">
            ...
            <h2 class="heading" style="float: left;"> Продукты проекта: Фото-рэй </h2>
...
$sql = "SELECT Продукт.id_продукта, Продукт.Название, Продукт.Описание, Продукт.Цена, СтатусПродукта.id_статуса_продукта, СтатусПродукта.Название AS Статус
        ...
        WHERE ПродуктыПроекта.Проект = 4";
